export interface PhotoEntry {
  /** Ruta relativa a /public/images/ o URL externa */
  url: string;
...
export interface PassengerEntry {
  /** Nombre visible */
  name: string;
  /** Emoji (si no hay imagen) */
  icon?: string;
  /** Ruta relativa a /public/images/ (opcional, tiene prioridad sobre icon) */
  image?: string;
  /** Descripción de lo que hace en el viaje */
  desc: string;
  /** Rol corto */
  role: string;
}
...
export interface CoupleConfig {
  ...
  designerName: string;
  /** ISO string — fecha de inicio del aniversario */
...
export const CONFIG: CoupleConfig = {
  ...
  photos: [
    {
      ...
      caption: "Una cita muy especial para mi, me permitio conocer algo que te encanta y probarlo, al descrubir que a mi tambien se me hizo super hermoso poder compartirlo contigo",
    },
    {
    ...
    },
    {
      ...
      displayName: 'Dormidos riquisimo',
    ...
    },
    {
      ...
      caption: 'Veinte, y ya sé exactamente con quién quiero celebrar el resto de cumpleaños.',
    },
    {
      ...
      [
        {
          ...
          desc: 'Asomado completamente por la ventana, con las orejas flotando al viento de la carretera. Es feliz así.',
        },
        {
          name: 'Perrito',
          icon: '🐶',
          role: 'Explorador',
          desc: 'Intentando atrapar las gotas de lluvia del vidrio y moviendo la cola al ritmo de la música.',
        },
        {
          name: 'Nutria A',
          icon: '🦦',
          role: 'Compañera de Sueño',
          desc: 'Tomada de la mano de su hermana, durmiendo pacíficamente en el asiento más cómodo.',
        },
      ],
      [
        {
          ...
          icon: '🦦',
          role: 'Compañera de Sueño',
          desc: 'Tomada de la mano de su hermana, durmiendo pacíficamente. Las dos son una sola bolita de felicidad.',
        },
        {
          name: 'Gatito',
          icon: '🐱',
          role: 'Pasajero Mimado',
          desc: 'Acurrucado sobre el abrigo abandonado en el asiento, ronroneando suavemente al ritmo del motor.',
        },
        {
          name: 'Erizo',
          icon: '🦔',
          role: 'Pequeño Viajero',
          desc: 'Hecho una bolita dentro de una taza de café vacía, disfrutando de la calidez del viaje.',
        },
      ],
      [
        {
          ...
          icon: '🦆',
          role: 'Observador',
          desc: 'Siguiendo el movimiento del limpiaparabrisas con muchísima atención y seriedad profesional.',
        },
        {
          name: 'Koala',
          icon: '🐨',
          role: 'Abrazador Oficial',
          desc: 'Sujeto firmemente al tubo del pasamanos, dormido en un largo viaje de carretera sin soltarse.',
        },
        {
          name: 'Carpinchito',
          icon: '🦫',
          role: 'El Conciliador',
          desc: 'Echado a lo ancho del pasillo con un pequeño sombrero de conductor, transmitiendo paz absoluta.',
        },
      ],
    ],
    back: [
      {
        ...
        icon: '🦙',
        role: 'Nube de Viaje',
        desc: 'Asomando su largo cuello desde el asiento de atrás, esponjosa y llenando de abrigo toda la buseta.',
      },
      {
        name: 'Alpaquita B',
        icon: '🦙',
        role: 'Nube de Viaje',
        desc: 'La hermana esponjosa, acurrucada al lado, con sus ojos curiosos siguiendo cada paisaje que pasa.',
      },
      {
        name: 'Conejo Gris',
        icon: '🐇',
        role: 'Soñador del Fondo',
        desc: 'Al fondo del todo, mirando hacia atrás por la luneta, despidiéndose de cada pueblo que dejamos atrás.',
      },
      {
        name: 'Tortuga',
        icon: '🐢',
        role: 'Filósofa del Viaje',
        desc: 'Con toda la paciencia del mundo, apoyada contra la ventana trasera. Para ella el destino nunca tiene prisa.',
      },
    ],
  },
  ...
  dateIdeas: [
    {
      title: '🍕 Tarde de Acuarelas & Pizza',
      description:
        'Colocamos manteles de papel en el suelo, abrimos un buen vino y nos pintamos el uno al otro sin pretensiones.',
    },
    {
      title: '🌅 Picnic Dorado al Atardecer',
      description:
        'Subir a nuestra colina preferida con una manta cómoda, fresas y música que nos traiga paz.',
    },
    {
      title: '🍵 Ruta de Té & Latte Art',
      description:
        'Perdernos en la ciudad buscando cafeterías acogedoras para calificar sus espacios y sus detalles.',
    },
    {
      title: '🏕️ Noche bajo el Cielo Abierto',
      description:
        'Una noche entera durmiendo bajo las estrellas, lejos de las notificaciones, solo nosotros dos conversando despacio.',
    },
    {
      title: '🍦 Helados & Caminata sin Reloj',
      description:
        'Caminar de la mano hasta encontrar sabores extraños de helado y disfrutar del silencio compartido.',
    },
  ],
};
